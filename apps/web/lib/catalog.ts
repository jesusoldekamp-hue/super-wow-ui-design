...
const r = (
  ...
  slug,
  url,
  image: `/resources/${slug}.svg`,
  imageAlt: `Vista visual de ${name}, recurso para diseño y desarrollo web.`,
  description,
  reason,
  category,
  type,
...
export const resources: Resource[] = [
  ...
  r("React Aria", "react-aria", "https://react-aria.adobe.com", "Hooks y componentes accesibles de Adobe.", "Excelente para patrones complejos e internacionalización.", "componentes", "libreria", ["React"], ["Accesibilidad", "i18n"], "Apache-2.0"),
  ...
  r("Web Quality Skills", "web-quality-skills", "https://github.com/addyosmani/web-quality-skills", "Reglas reutilizables para Lighthouse, Core Web Vitals, WCAG 2.2 y SEO.", "Reúne criterios prácticos para revisar rendimiento, accesibilidad y calidad antes de publicar una web.", "rendimiento", "skill", ["Web"], ["Lighthouse", "WCAG", "SEO"], "MIT", "gratis", true),
  r("Playwright MCP", "playwright-mcp", "https://github.com/microsoft/playwright-mcp", "Servidor MCP oficial para automatizar navegador con Playwright.", "Permite que agentes inspeccionen, prueben y verifiquen interfaces reales desde el navegador.", "rendimiento", "skill", ["Web", "MCP"], ["Testing", "Automatización"], "Apache-2.0"),
  ...
  r("Glassmorphism", "glassmorphism", "https://css.glass", "Paneles translúcidos con profundidad.", "Aporta capas modernas si mantiene contraste y legibilidad.", "patrones", "patron", ["Web"], ["CSS", "UI"], "Patrón de diseño"),
  ...
  r("TypeUI", "typeui", "https://github.com/bergside/typeui", "Genera especificaciones de sistema visual y skills para asistentes de código.", "Convierte criterios de diseño en contexto reutilizable para Codex, Claude, Cursor y otras herramientas de IA.", "patrones", "skill", ["AI", "Web"], ["Design system", "Skills"], "MIT"),
  r("Design MD Chrome", "design-md-chrome", "https://github.com/bergside/design-md-chrome", "Extensión Chrome para extraer estilos de webs y generar DESIGN.md.", "Ayuda a transformar referencias visuales reales en guías de diseño accionables para IA.", "patrones", "skill", ["AI", "Chrome"], ["Design.md", "Extracción visual"], "MIT"),
]
