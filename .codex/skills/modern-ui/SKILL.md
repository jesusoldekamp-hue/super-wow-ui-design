---
name: modern-ui
description: Build original premium Next.js websites with this repository's UI, animation, scroll, SVG, and WebGL stack.
---

# Modern UI Builder

Use this skill when creating or substantially redesigning a website in this repository.

## Required reading

Read `AGENTS.md`, `docs/AI_WORKFLOW.md`, `docs/STACK.md`, and `docs/QUALITY_BAR.md`.

## Workflow

1. Inspect the current application and choose the closest template.
2. Turn the request into a concrete content and interaction brief.
